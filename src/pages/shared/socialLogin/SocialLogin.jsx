...
const SocialLogin = () => {
    ...
    const handleGoogleLogin = () => {
        googleSignIn()
            .then(result => {
                const setUser = { name: result.user.displayName, email: result.user.email, date: result.user.metadata.creationTime }
                axiosPublic.post('/users', setUser)
                    .then(result => {
                        navigate('/')
    ...
    return (
        <div>
            <div className="py-3 flex items-center text-sm text-black before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:before:border-neutral-600 dark:after:border-neutral-600">
                Or
            </div>
            <div className="flex flex-col items-center">
                <p>already registered? <Link to={'/sign-in'} className="text-yellow-600">Go to login</Link> </p>
                <span>Or Sign Up With</span>
            </div>
            <div className="space-x-6 flex justify-center my-8">
                ...
                <button type="button"
                    className="border-none outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32px" viewBox="0 0 50 50">
